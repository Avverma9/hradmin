      ...
      {data?.map((hotel) => (
        <div key={hotel?._id} className="hotel-card">
          ...
          <div className="hotel-details">
            ...
            <p>{hotel?.city}, {hotel?.state} • {hotel?.landmark}</p>
            ...
            <div className="hotel-actions">
              <button className="details-btn" onClick={() => handleBookNow(hotel?.hotelId)}>View Details</button>
              <button className="book-btn" onClick={() => handleBookNow(hotel?.hotelId)}>Book Now</button>
            </div>
          </div>
        </div>
      ))}
