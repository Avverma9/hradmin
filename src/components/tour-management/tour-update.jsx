...
export default function TourUpdate() {
  ...
  return (
    <div>
      ...
      <Typography>
        Important ! - Every field is editable click on edit icon and proceed
      </Typography>
          ...
          <div className="package-card">
            {editableData.map((pkg, index) => (
              <div key={pkg._id || index} className="package-info">
                      ...
                      {editMode[`${index}-travelAgencyName`] ? (
                        <>
                          ...
                          <div className="buttons">
                            <button
                              onClick={() =>
                                toggleEditMode(index, "travelAgencyName")
                              }
                              title="Cancel"
                            >
                              ✖
                            ...
                            <button
                              onClick={() =>
                                handleUpdate(index, "travelAgencyName")
                              }
                              title="Update"
                            >
                              ✔
                  ...
                  <div className="field-control">
                    {editMode[`${index}-overview`] ? (
                      <>
                        ...
                        <div className="buttons">
                          <button
                            onClick={() => toggleEditMode(index, "overview")}
                            title="Cancel"
                          >
                            ✖
                          </button>
                          <button
                            onClick={() => handleUpdate(index, "overview")}
                            title="Update"
                          >
                            ✔
                          </button>
                    ...
                    <div className="field-control">
                      {editMode[`${index}-state`] ? (
                        <>
                          ...
                          <div className="buttons">
                            <button
                              onClick={() => toggleEditMode(index, "state")}
                              title="Cancel"
                            >
                              ✖
                            </button>
                            <button
                              onClick={() => handleUpdate(index, "state")}
                              title="Update"
                            >
                              ✔
                            </button>
                    ...
                    <div className="field-control">
                      {editMode[`${index}-city`] ? (
                        <>
                          ...
                          <div className="buttons">
                            <button
                              onClick={() => toggleEditMode(index, "city")}
                              title="Cancel"
                            >
                              ✖
                            </button>
                            <button
                              onClick={() => handleUpdate(index, "city")}
                              title="Update"
                            >
                              ✔
                            </button>
                    ...
                    <div className="field-control">
                      {editMode[`${index}-price`] ? (
                        <>
                          ...
                          <div className="buttons">
                            <button
                              onClick={() => toggleEditMode(index, "price")}
                              title="Cancel"
                            >
                              ✖
                            </button>
                            <button
                              onClick={() => handleUpdate(index, "price")}
                              title="Update"
                            >
                              ✔
                            </button>
                      ...
                      {editMode[`${index}-nights`] ? (
                        <>
                          <input
                            ...
                            value={pkg.nights || ""}
                            onChange={(e) =>
                              handleInputChange(index, "nights", e.target.value)
                            }
                          />
                          <div className="buttons">
                            <button
                              onClick={() => toggleEditMode(index, "nights")}
                              title="Cancel"
                            >
                              ✖
                            </button>
                            <button
                              onClick={() => handleUpdate(index, "nights")}
                              title="Update"
                            >
                              ✔
                            </button>
                    ...
                    <div className="field-control">
                      {editMode[`${index}-days`] ? (
                        <>
                          ...
                          <div className="buttons">
                            <button
                              onClick={() => toggleEditMode(index, "days")}
                              title="Cancel"
                            >
                              ✖
                            </button>
                            <button
                              onClick={() => handleUpdate(index, "days")}
                              title="Update"
                            >
                              ✔
                            </button>
                    ...
                    <div className="field-control">
                      {editMode[`${index}-from`] ? (
                        <>
                          ...
                          <div className="buttons">
                            <button
                              onClick={() => toggleEditMode(index, "from")}
                              title="Cancel"
                            >
                              ✖
                            </button>
                            <button
                              onClick={() => handleUpdate(index, "from")}
                              title="Update"
                            >
                              ✔
                            </button>
                    ...
                    <div className="field-control">
                      {editMode[`${index}-to`] ? (
                        <>
                          ...
                          <div className="buttons">
                            <button
                              onClick={() => toggleEditMode(index, "to")}
                              title="Cancel"
                            >
                              ✖
                            </button>
                            <button
                              onClick={() => handleUpdate(index, "to")}
                              title="Update"
                            >
                              ✔
                            </button>
                ...
                <label className="input-label">Daywise </label>
                        ...
                        {editMode[`${index}-day-${dayIndex}`] ? (
                          <>
                            ...
                            <div className="buttons">
                              <button
                                onClick={() =>
                                  toggleEditMode(index, `day-${dayIndex}`)
                                }
                                title="Cancel"
                              >
                                ✖
                              ...
                              <button
                                onClick={() =>
                                  handleUpdate(index, `day-${dayIndex}`)
                                }
                                title="Update"
                              >
                                ✔
