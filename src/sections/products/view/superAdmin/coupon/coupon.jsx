...
import RoomModal from 'src/sections/settings/coupon/room-modal';
import CouponCodeModal from 'src/sections/settings/coupon/coupon-code';
import CreateCouponModal from 'src/sections/settings/coupon/create-coupon';
import AppliedCouponModal from 'src/sections/settings/coupon/applied-coupon';
import AvailableCouponsModal from 'src/sections/settings/coupon/available-coupons';
