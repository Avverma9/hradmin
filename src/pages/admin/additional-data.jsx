...
const DATASET_CONFIG = [
  ...
  },
  {
    ...
    inputPlaceholder: 'Add hotel category',
    singularLabel: 'hotel category',
    icon: ConciergeBell,
    fetchAction: getHotelCategories,
    addAction: addHotelCategory,
    deleteAction: deleteHotelCategory,
  },
  {
    key: 'propertyTypes',
    title: 'Property Types',
    placeholder: 'Search Property Types...',
    inputPlaceholder: 'Add property type',
    singularLabel: 'property type',
    icon: Building2,
    fetchAction: getPropertyTypes,
    addAction: addPropertyType,
