...
export const paths = [
  ...
  { title: 'PMS Manage Coupons', path: '/apply-pms-coupon', role: 'PMS' },
  ...
  { title: 'Set Month', path: '/hotels/monthly-price', role: 'PMS' },
  { title: 'Change banner', path: '/change-banner', role: 'Admin' },
  { title: 'Admin Manage Coupons', path: '/apply-coupon', role: 'Admin' },
